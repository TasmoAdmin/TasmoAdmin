...
<form class='center' name='update_form' method='post' enctype='multipart/form-data'
	...
	<table border='0' cellspacing='0' class='center-table'>
		...
		<tr>
			<td>
				<input type='file' name='new_firmware' required='required'>
			</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		...
		<tr>
			<td>
				<button type='submit' class='btn widget' name='auto' value='submit' title='<?php echo __(
					"BTN_UPLOAD_AUTOMATIC_HELP",
					"DEVICE_UPDATE"
				); ?>'
