			...
			<div class='row'>
				<div class='col col-12'>
					...
					<div class="tab-content mt-3" id="device_configContent">
						<div class="tab-pane fade <?php echo 0 == $activeTabIndex ? 'show active' : ''; ?>"
						...
						<div class="tab-pane fade <?php echo 1 == $activeTabIndex ? 'show active' : ''; ?>"
						...
						<div class="tab-pane fade <?php echo 2 == $activeTabIndex ? 'show active' : ''; ?>"
							 id="config_mqtt_tab"
							 role="tabpanel"
