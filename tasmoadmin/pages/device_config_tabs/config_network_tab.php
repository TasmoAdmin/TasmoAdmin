					...
					<div class="row g-3">
						<div class="form-group col col-12 col-md-6">
							...
							<input type="text"
						       ...
						       value='<?php echo HtmlAttributeHelper::escape(isset($status->StatusNET->Hostname)
						...
						<div class="form-group col col-12 col-md-6">
							...
							<input type="text"
							       ...
							       name='NtpServer1'
							       placeholder="<?php echo __('PLEASE_ENTER'); ?>"
						       value='<?php echo HtmlAttributeHelper::escape(isset($status->statusNTP->NtpServer1)
						...
						<div class="form-group col col-12 col-md-6">
							...
							<input type="text"
							       ...
							       name='IPAddress1'
							       placeholder="<?php echo __('PLEASE_ENTER'); ?>"
						       value='<?php echo HtmlAttributeHelper::escape(isset($status->StatusNET->IPAddress)
						...
						<div class="form-group col col-12 col-md-6">
							...
							<input type="text"
							       ...
							       name='IPAddress2'
							       placeholder="<?php echo __('PLEASE_ENTER'); ?>"
						       value='<?php echo HtmlAttributeHelper::escape(isset($status->StatusNET->Gateway)
						...
						<div class="form-group col col-12 col-md-6">
							...
							<input type="text"
							       ...
							       name='IPAddress3'
							       placeholder="<?php echo __('PLEASE_ENTER'); ?>"
						       value='<?php echo HtmlAttributeHelper::escape(isset($status->StatusNET->Subnetmask)
						...
						<div class="form-group col col-12 col-md-6">
							...
							<input type="text"
							       ...
							       name='IPAddress4'
							       placeholder="<?php echo __('PLEASE_ENTER'); ?>"
						       value='<?php echo HtmlAttributeHelper::escape(isset($status->StatusNET->DNSServer)
						...
						<div class="form-group col col-12">
							...
							<input type="text"
							       ...
							       placeholder="<?php echo __('PLEASE_ENTER'); ?>"
						       value='<?php echo HtmlAttributeHelper::escape(isset($status->StatusNET->Mac)
					...
					<div class="row g-3 mt-1">
						<div class="form-group col col-12 col-md-6">
							...
							<input type="text"
							       ...
							       name='SSId1'
							       placeholder="<?php echo __('PLEASE_ENTER'); ?>"
						       value='<?php echo HtmlAttributeHelper::escape(isset($status->StatusLOG->SSId1)
						...
						<div class="form-group col col-12 col-md-6">
							...
							<input type="text"
							       ...
							       name='SSId2'
							       placeholder="<?php echo __('PLEASE_ENTER'); ?>"
						       value='<?php echo HtmlAttributeHelper::escape(isset($status->StatusLOG->SSId2)
