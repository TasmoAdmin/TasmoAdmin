...
These steps are were tested on FreeNAS and assume you have already [activated iocage](https://iocage.readthedocs.io/en/latest/basic-use.html#activate-iocage) and [fetched the 11.1-RELEASE](https://iocage.readthedocs.io/en/latest/basic-use.html#fetch-a-release).
